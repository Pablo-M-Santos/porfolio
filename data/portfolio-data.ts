...
export const socialLinks = [
  { name: "GitHub", icon: "Github", href: "https://github.com/Pablo-M-Santos" },
  {
    name: "LinkedIn",
    icon: "Linkedin",
  ...
  },
  {
    name: "Email",
    icon: "Mail",
    href: "mailto:pablomoreirasantos.hp@email.com",
  },
];
...
export const certificates = [
  {
    ...
    institution: "DIO",
    description:
      "Participei do Bootcamp da DIO com HTML, CSS e JavaScript, onde pude melhorar meus conhecimentos e minhas habilidades.",
  ...
  },
  {
    ...
    institution: "IFCE",
    description:
      "Participei no Arduino Day na programação de seguidores de linha e projeto de exposição utilizando a linguagem C++ para desenvolver os sistemas.",
  ...
  },
  {
    ...
    description:
      "Participei do curso de criação de site usando HTML, CSS e JavaScript da fundação bradesco onde pude aprimorar minhas abilidades.",
...
export const courses = [
  ...
  },
  {
    ...
    name: "@nuxt/image",
    description:
      "Optimized images for Nuxt with automatic srcset and lazy loading.",
    stars: "234.5K",
    forks: "2.1K",
  },
  {
